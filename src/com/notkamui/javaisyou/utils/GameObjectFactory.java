...
class GameObjectFactory {
    ...
    void addType(String stringType) {
        ...
        var dir = "resources/assets/nouns/%s/".formatted(stringType);
        var nounPic = new ImageIcon("%sText_%s_0.gif".formatted(dir, stringType));
        var elemPic = new ImageIcon("%s%s_0.gif".formatted(dir, stringType));
